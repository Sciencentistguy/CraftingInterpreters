...
Token::Token(const char* errorMsg, const Lexer& scanner) : type{TokenType::Error}, start{errorMsg}, length{static_cast<int>(std::strlen(errorMsg))}, line{scanner.getLine()} {
}